    ...
    <section id="about" className="aboutSection contenedor" >
      ...
      <div className="aboutCard">
        ...
        <div className="aboutCardContent">
          ...
          <p>
          Mi enfoque orientado a soluciones y mi habilidad para colaborar en equipos multidisciplinarios me han permitido liderar proyectos exitosos y entregar resultados de alta calidad de manera eficiente. La programación no solo es una habilidad técnica, sino una ventaja competitiva que me distingue en el entorno profesional.
          </p>
        </div>
      </div>
    </section>
