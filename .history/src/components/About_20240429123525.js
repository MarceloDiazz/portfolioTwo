    ...
    <section id="about" className="aboutSection contenedor">
      ...
      <div className="aboutCard">
        ...
        <div className="aboutCardContent">
          <p className="aboutCardParaGraph">Mi nombre es Marcelo, lo que al principio era un simple interés se convirtió rápidamente en una verdadera <span>pasión</span>. La sensación de escribir líneas de código y ver cómo cobraban vida en la pantalla era incomparable. Cada desafío que enfrentaba en el camino solo aumentaba mi determinación de dominar este arte.</p>
          <p className="aboutCardParaGraph">
            A pesar de mi corta experiencia, asumí el desafío de <span>liderar</span> todo el
